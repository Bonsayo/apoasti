...
4. Dermatological Clinics (Skin Care)
...
for line in lines:
    ...
    if len(parts) == 3:
        ...
        # mock departments based on category
        departments = ""
        if "Dental" in current_category:
            departments = """      {
        id: "dentistry",
        name: "Dentistry",
        nameAm: "የጥርስ ሕክምና",
        ...
        elif "Skin" in current_category or "Dermatological" in current_category:
             departments = """      {
        id: "dermatology",
        name: "Dermatology",
        nameAm: "የቆዳ ሕክምና",
        ...
        features_escaped = features.replace('"', '\\"')
...
with open("d:\\\\appointement\\\\astawash-app\\\\src\\\\data\\\\hospitals.ts", "w", encoding="utf-8") as f:
    f.write(out.replace('True', 'true'))
